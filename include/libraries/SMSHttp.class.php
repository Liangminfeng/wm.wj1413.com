<?php
class SMSHttp{
    public $username = "I61740252";
    public $password = "33555d77b7081cf43448aca39ca5b334";
	...
	function SMSHttp(){
		$this->smsHost = "api.isms.ihuyi.com";
		$this->sendSMSUrl = "http://".$this->smsHost."/webservice/isms.php?method=Submit";
	...
	function getCredit($userID=null, $password=null){
	...
	function sendSMS($subject, $content, $mobile, $sendTime){
		...
		$success = false;
		$postDataString = "account=" . $userID;
		$postDataString .= "&password=" . $password;
		//$postDataString .= "&SB=" . $subject;
		$postDataString .= "&content=" . $content;
		$postDataString .= "&mobile=" . $mobile;
		$postDataString .= "&time=" . $sendTime;
		$postDataString .= "&format=json";
