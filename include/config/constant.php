...
define('CART_ACCESSORY_GOODS',       5); // 积分商城
...
define('OS_SPLITED',                5); // 已收货
//自定义订单状态
define('OS_SPLITING_PART',          6); // 部分分单
define('OS_WATTING',                7); // 待激活
define('OS_HIDE',                   9); // 隱藏單
...
define("ACCTYPE_RECHARGE", 1); //充值
define("ACCTYPE_WITHDRAW", 2); //提现
define("ACCTYPE_MANAGER", 3);  //管理员调节
define("ACCTYPE_BONUS", 4);    //奖金发放  
define("ACCTYPE_TURNTO", 5); //转出转入
define("ACCTYPE_SPENDING", 6); //消费
define("ACCTYPE_OTHER", 99);   //其他
