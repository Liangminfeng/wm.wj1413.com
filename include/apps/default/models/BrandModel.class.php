...
class BrandModel extends BaseModel {
    ...
    function brand_get_goods($brand_id, $cate, $sort, $order, $size, $page) {
        ...
        foreach ($res as $row) {
            ...
            $arr[$row['goods_id']]['shop_price'] = price_format($row['shop_price']-$row['integral'])."+".number_format(($row['integral']*100/C(integral_scale)),0)."积分";
