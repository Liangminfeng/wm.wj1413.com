...
$_LANG['label_user_lxpoint'] = '财富金管理';
...
/* 会员余额(预付款) */
$_LANG['add_surplus_log'] = '交易记录';
$_LANG['view_application'] = '提现记录';
$_LANG['surplus_pro_type'] = '类型';
$_LANG['repay_money'] = '提现金额';
$_LANG['repay_out_money'] = '转出到余额账户';
$_LANG['money'] = '金额';
...
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
$_LANG['surplus_amount_error'] = '您要申请提现的奖金金额超过了您现有的奖金余额，此操作将不可进行！';
$_LANG['surplus_appl_submit'] = '您的提现申请已成功3提交，请等待管理员的审核！';
...
/* 会员密码找回 */
$_LANG['username_and_email'] = '请输入您注册的会员帐号和注册时填写的电子邮件地址。';
$_LANG['enter_new_password'] = '请输入您的新密码';
$_LANG['username_no_email'] = '您填写的会员帐号与电子邮件地址不匹配，请重新输入！';
...
$_LANG['username_not_match_email'] = '会员帐号与电子邮件地址不匹配，请重新输入！';
$_LANG['get_question_username'] = '请输入您注册的会员帐号以取得您的密码提示问题。';
...
//JS语言项
$_LANG['password_js']['user_name_empty'] = '请输入您的会员帐号！';
...
$_LANG['order_paytime'] = '付款时间';
$_LANG['order_shippingtime'] = '发货时间';
$_LANG['order_confirm_receive_time'] = '收货时间';
$_LANG['order_money'] = '订单总额';
...
$_LANG['confirm_cancel'] = '您是否确认要取消退换货申请';
...
$_LANG['return_integral_on_cancel'] = '取消订单 %s，退回支付订单时使用的鱼宝';
...
$_LANG['free_registered'] = '立即注册';
$_LANG['third_login'] = '使用合作帐号登录';
$_LANG['no_register_auth'] = '还没有注册该插件，请与后台管理员联系';
$_LANG['msg_un_blank'] = '会员帐号不能为空';
$_LANG['msg_mast_length'] = '会员帐号必须为3-15个字符';
$_LANG['msg_un_length'] = '会员帐号最长不得超过7个汉字';
$_LANG['msg_un_format'] = '会员帐号含有非法字符';
$_LANG['msg_un_registered'] = '会员帐号已经存在,请重新输入';
...
$_LANG['login_failure'] = '会员编号或密码错误';
$_LANG['sms_failure'] = '验证码错误';
$_LANG['mobile_failure'] = '手机号错误';
$_LANG['account_error'] = '您的账号已冻结';
$_LANG['account_error_01'] = '您的账号已终止';
$_LANG['login_error'] = '您未登录';
...
$_LANG['username_empty'] = '会员帐号为空';
$_LANG['username_invalid'] = '会员帐号 %s 含有敏感字符';
$_LANG['username_exist'] = '会员帐号 %s 已经存在';
$_LANG['username_not_allow'] = '会员帐号 %s 不允许注册';
...
$_LANG['register'] = '注册';
$_LANG['register_success'] = '会员帐号 %s 注册成功';
...
$_LANG['msg_input_namepwd'] = '请输入会员帐号或密码';
$_LANG['msg_account_bound'] = '当前帐号已经绑定了哦';
$_LANG['msg_account_bound_fail'] = '帐号绑定失败';
...
$_LANG['passport_js']['username_empty'] = '- 会员帐号不能为空。';
$_LANG['passport_js']['username_shorter'] = '- 会员帐号长度不能少于 3 个字符。';
$_LANG['passport_js']['username_longer'] = '- 会员帐号长度不能超过15个字符。';
$_LANG['passport_js']['username_invalid'] = '- 会员帐号只能是由字母数字以及下划线组成。';
...
$_LANG['passport_js']['msg_un_blank'] = '* 会员帐号不能为空';
$_LANG['passport_js']['msg_un_length'] = '* 会员帐号最长不得超过7个汉字';
$_LANG['passport_js']['msg_un_format'] = '* 会员帐号含有非法字符';
$_LANG['passport_js']['msg_un_registered'] = '* 会员帐号已经存在,请重新输入';
...
$_LANG['register_affiliate'] = '推荐会员 %s 注册送鱼宝';
$_LANG['register_points'] = '注册送鱼宝';
...
$_LANG['look_apply_record'] = '查看申请记录';
$_LANG['return_detail'] = '退换货详情';
$_LANG['apply_customer_service']='申请售后';
$_LANG['shipping_fee'] = '配送费用';
$_LANG['goods_amount'] = '商品金额';
$_LANG['unpay_fee'] = '待付金额';
$_LANG['all_order'] = '全部';
$_LANG['unpay_order'] = '待付款';
$_LANG['unreceived_order'] = '待收货';
$_LANG['unreview_order'] = '待评价';
$_LANG['return_order'] = '退/换货 ';
$_LANG['no_orders'] = '没有相关订单哦';
$_LANG['unsend_order_msg'] = '订单暂未发货，请稍后再来查询';
$_LANG['my_profile'] = '我的资料';
$_LANG['change_avatar'] = '点击更换头像';
$_LANG['base_profile'] = '基本资料';
$_LANG['change_nick_name'] = '修改昵称';
$_LANG['save'] = '保存' ;
$_LANG['nick_name_msg'] = '好名字可以让朋友更容易记住你';
$_LANG['change_mobile'] = '修改手机号';
$_LANG['find_pass_msg'] = '用于名片展示及密码找回';
$_LANG['change_email'] = '修改邮箱';

$_LANG['profile'] = '个人资料';
$_LANG['choose_job'] = '选择职位';
$_LANG['sale_rep'] = '业务代表';
$_LANG['sale_elite'] = '业务精英';
$_LANG['consignee_list'] = '收货地址';
$_LANG['mainpage'] = '个人主页';
...
$_LANG['ID_type_1'] = '身份证';
$_LANG['ID_type_2'] = '护照';
$_LANG['ID_type_3'] = '港澳台通行证';
$_LANG['withdraw_apply'] = '申请提现';
$_LANG['bonus_apply'] = '提现';
$_LANG['pending_hand_out'] = '待发放';
$_LANG['already_hand_out'] = '已发放';
$_LANG['no_qualification'] = '无资格';
$_LANG['current_weight'] = '当前权重';
$_LANG['top_amount'] = '封顶金额';
$_LANG['no_top'] = '无上限 全国分红';
$_LANG['nodata'] = '暂无数据';
$_LANG['pay_atonce'] = '立即支付';
$_LANG['pending_send_out'] = '待发货';
$_LANG['os_cancel'] = '已取消';
$_LANG['pending_activation'] = '待激活';
$_LANG['password_twice_difference'] = '请输入两次相同的密码';
$_LANG['unbind_success'] = '解邦成功';
$_LANG['account_bind_msg'] = '请先填写并验证手机号';

$_LANG['account_bind_msg1'] = '帐号未邦定';

$_LANG['authority_manage'] = '授权管理';
$_LANG['user_name_empty'] = '用护名不能为空';
$_LANG['password_empty'] = '密码不能为空';



$_LANG['account_bind_msg2'] = '已关联帐号';
$_LANG['account_bind_msg3'] = '该帐号已被关联！';
$_LANG['account_bind_msg4'] = '帐号不存在，请重新输入！';


$_LANG['account_unbind_msg5'] = '请不要频繁操作！每次登录只能解除关联一次';
$_LANG['account_unbind_success'] = '解除关联成功';
$_LANG['account_not_exist'] = '帐号不存在';
$_LANG['unpay']= '未付款';

$_LANG['ps_payed'] = '已付款';

$_LANG['ss_received'] = '收货确认';
$_LANG['already_receive'] = '已收货';

$_LANG['ss_shipped'] = '已发货';
$_LANG['already_refund'] = '已退货';

$_LANG['pls_input_password'] = '请输入密码';
$_LANG['account_exist'] ='账号已存在';
$_LANG['returns_apply_msg'] = '此商品已下架，请选择退货';
$_LANG['to_return_error'] = '退货出现异常，请稍后重试';
$_LANG['loadlandpage_title'] = '您的好友邀您加入会省钱更会赚钱的商城';
$_LANG['loadlandpage_des'] = '拓客商城，专注健康产品，自用省钱，分享赚钱，为您提供便捷的一站式服务';
$_LANG['cancelorder_msg'] = '订单自动取消';
$_LANG['order_not_exist_msg'] ='订单不存在';
