 ...
 * ECSHOP 会员预付款管理语言项
 * ============================================================================
 * * 版权所有 2005-2012 上海商派网路科技有限公司，并保留拥有权利。
 * 网站位址 : HTTP://www.ecshop.com ；
 * ----------------------------------------------------------------------------
 * 这不是一个自由软体！ 您只能在不用于商业目的的前提下对程式码进行修改和
 * 使用；不允许对程式码以任何形式任何目的的再发佈。
 * ============================================================================
 * $Author: liubo $
...
$_LANG['bank'] = ' 开户行';
$_LANG['bank_card'] = ' 银行卡';
$_LANG['autonym_mobile_phone'] = ' 联系电话';
$_LANG['add_date'] = ' 操作日期';
...
$_LANG['surplus_amount_error'] = ' 要提现的金额超过了此会员的帐户馀额，此操作将不可进行！ ';
