...
$_LANG['is_indepent_bonus'] = '独立分成佣金：';
...
$_LANG['lab_integral'] = '普通积分购买金额：';
$_LANG['vip_lab_integral'] = 'VIP KD豆购买金额：';
$_LANG['lab_give_integral'] = '普通会员赠送KD豆数：';
$_LANG['vip_lab_give_integral'] = '购买VIP套餐赠送的KD豆：';
...
$_LANG['notice_integral'] = '(此处需填写金额)购买该商品时最多可以使用KD豆的金额';

$_LANG['notice_give_integral'] = '普通会员购买该商品时赠送KD豆数,-1表示按商品价格赠送';
$_LANG['notice_vip_give_integral'] = '购买VIP套餐赠送KD豆数,-1表示按商品价格赠送';
...
$_LANG['goods_sn_exists'] = '您输入的货号已存在，请换一个';
$_LANG['lab_rtgoods_cat'] = '入团商品分类：';
$_LANG['lab_lsgoods_cat'] = '零售商品分类：';
?>