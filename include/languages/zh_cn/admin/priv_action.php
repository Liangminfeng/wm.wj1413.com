...
$_LANG['postercat_list'] = '海报分类';
$_LANG['poster_list'] = '海报清单';
$_LANG['goods_kd_cash_scale'] = '鱼宝现金使用比例';
...
$_LANG['talk_manage'] = '话题管理';
$_LANG['talk_sucai_list'] = '动态素材';
//邮件管理
