...
$_LANG['return_order_integral'] = '由于取消、无效或退货操作，退回支付订单 %s 时使用的鱼宝';
$_LANG['order_gift_integral'] = '订单 %s 赠送的鱼宝';
$_LANG['return_order_gift_integral'] = '由于退货或未发货操作，退回订单 %s 赠送的鱼宝';
