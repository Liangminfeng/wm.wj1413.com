...
$_LANG['user_rank'] = '经销商等级';
$_LANG['user_vip'] = 'VIP等级';
...
$_LANG['notice_pay_points'] = 'KD豆是一种站内货币，允许用户在购物时支付一定比例的KD豆。';
...
$_LANG['js_languages']['invalid_pay_points'] = 'KD豆数不是一个整数。';
