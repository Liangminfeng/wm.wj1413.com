...
$_LANG['calendar_lang']['Monday'] = '星期壹';
...
$_LANG['calendar_lang']['January'] = '壹月';
...
$_LANG['calendar_lang']['November'] = '十壹月';
$_LANG['calendar_lang']['December'] = '十二月';
$_LANG['calendar_lang']['Jan'] = '壹月';
...
$_LANG['calendar_lang']['calendar_about_time'] = "\\r\\n\\r\\n選擇時間:\\r\\n- 點擊小時或分鐘可使改數值加壹\\r\\n- 按住Shift鍵點擊小時或分鐘可使改數值減壹\\r\\n- 點擊拖動鼠標可進行快速選擇";
$_LANG['calendar_lang']['prev_year'] = "上壹年 (按住出菜單)";
$_LANG['calendar_lang']['prev_month'] = "上壹月 (按住出菜單)";
$_LANG['calendar_lang']['go_today'] = "轉到今日";
$_LANG['calendar_lang']['next_month'] = "下壹月 (按住出菜單)";
$_LANG['calendar_lang']['next_year'] = "下壹年 (按住出菜單)";
