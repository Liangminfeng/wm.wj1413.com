...
$_LANG['log_action']['batch_remove'] = ' 大量刪除';
...
$_LANG['log_action']['batch_edit'] = ' 大量編輯';
...
$_LANG['log_action']['shophelp'] = ' 網店説明文章';
$_LANG['log_action']['shophelpcat'] = ' 網店説明分類';
$_LANG['log_action']['shopinfo'] = ' 網店資訊文章';
$_LANG['log_action']['attribute'] = ' 屬性';
$_LANG['log_action']['privilege'] = ' 版權管理';
$_LANG['log_action']['user_rank'] = ' 會員等級';
$_LANG['log_action']['snatch'] = ' 奪寶奇兵';
$_LANG['log_action']['bonustype'] = ' 紅包類型';
$_LANG['log_action']['userbonus'] = ' 使用者紅包';
$_LANG['log_action']['vote'] = ' 線上調查';
$_LANG['log_action']['friendlink'] = ' 友情連結';
...
$_LANG['log_action']['adminlog'] = ' 動作記錄';
$_LANG['log_action']['admin_message'] = ' 管理員留言';
$_LANG['log_action']['users_comment'] = ' 使用者評論';
...
$_LANG['log_action']['fckfile'] = 'FCK 檔';
...
$_LANG['log_action']['suppliers'] = ' 供應商管理';
