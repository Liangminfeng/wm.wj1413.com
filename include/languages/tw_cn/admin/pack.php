...
$_LANG['pack_list_lnk'] = ' 返回清單頁面';

/*説明資訊*/
$_LANG['notice_packfee'] = ' 使用這個包裝所需要支付的費用，免費時設置為 0';
$_LANG['notice_freemoney'] = ' 當使用者消費金額超過這個值時，將免費使用這個包裝。 <br /> 設置為0時表明必須支付包裝費用';
...
$_LANG['enter_num'] = ' 請輸入一個數位！ ';
$_LANG['no_packname'] = ' 你輸入的包裝名稱為空！ ';

$_LANG['back_list'] = ' 返回包裝清單';
$_LANG['continue_add'] = ' 繼續添加新包裝';

/*JS 語言項*/
$_LANG['js_languages']['no_packname'] = ' 沒有輸入包裝名';
$_LANG['js_languages']['packfee_un_num'] = ' 包裝費用為空或不是數位';
$_LANG['js_languages']['packmoney_un_num'] = ' 包裝免費額度為空或不是數位';
