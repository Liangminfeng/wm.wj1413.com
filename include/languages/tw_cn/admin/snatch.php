...
$_LANG['make_option'] = ' 請先搜索商品生成選項清單';
...
/* 説明資訊 */
$_LANG['notice_goodsid'] = ' 需要先搜索商品，生成商品清單，然後再選擇';
...
$_LANG['js_languages']['invalid_min_price'] = ' 價格下限為空或不是數位';
$_LANG['js_languages']['invalid_max_price'] = ' 最多需支付的價格為空或不是數位';
