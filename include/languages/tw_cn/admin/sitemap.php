...
$_LANG['generate_success'] = ' 網站地圖已經生成到相應目錄下。 <br />位址為：%s';
$_LANG['generate_failed'] = ' 生成網站地圖失敗，請檢查 網站根目錄、/data/ 目錄是否允許寫入.';
$_LANG['sitemaps_note'] = 'Sitemaps 服務旨在使用 Feed 檔 sitemap.xml 通知 Google 、 Yahoo ! 以及 Microsoft 等 Crawler(爬蟲) 網站上哪些檔需要索引、這些檔的最後修訂時間、更改頻度、檔位置、相對優先索引權，這些資訊將説明他們建立索引範圍和索引的行為習慣。 詳細資訊請查看 <a href="HTTP://www.sitemaps.org/" target="_blank">sitemaps.org</a> 網站上的說明。 ';
?>