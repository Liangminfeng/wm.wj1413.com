...
$_LANG['separate_info2'] = ' 使用者 ID %s ( %s ), 分成 : 金錢 %s 積分 %s';
$_LANG['sch_order'] = ' 搜索訂單號';
$_LANG["separate_will"] = "预计分成:: 使用者 ID %s ( %s ), 分成 : 金錢 %s 積分 %s";
...
$_LANG['show_affiliate_orders'] = ' 此清單顯示此使用者推薦的訂單資訊。 ';
