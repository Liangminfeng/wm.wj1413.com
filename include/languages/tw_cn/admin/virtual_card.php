...
//-- 卡片資訊
/*------------------------------------------------------ */
$_LANG['virtual_card_list'] = ' 虛擬商品清單';
...
$_LANG['batch_card_add'] = ' 大量新增補貨';
$_LANG['download_file'] = ' 下載批量 CSV 檔';
$_LANG['separator'] = ' 分隔符號';
$_LANG['uploadfile'] = ' 上傳檔';
$_LANG['sql_error'] = ' 第 %s 條資訊出錯： <br /> ';

/* 提示資訊 */
$_LANG['replenish_no_goods_id'] = ' 缺少商品 ID 參數，無法進行補貨操作';
$_LANG['replenish_no_get_goods_name'] = ' 商品 ID 參數有誤，無法獲取商品名';
$_LANG['drop_card_success'] = ' 該記錄已成功刪除';
$_LANG['batch_drop'] = ' 大量刪除';
$_LANG['drop_card_confirm'] = ' 你確定要刪除該記錄嗎？ ';
$_LANG['card_sn_exist'] = ' 卡片序號 %s 已經存在，請重新輸入';
$_LANG['go_list'] = ' 返回補貨清單';
$_LANG['continue_add'] = ' 繼續補貨';
$_LANG['uploadfile_fail'] = ' 檔上傳失敗';
$_LANG['batch_card_add_ok'] = ' 已成功添加了 %s 條補貨資訊';

$_LANG['js_languages']['no_card_sn'] = ' 卡片序號和卡片密碼不能都為空。 ';
$_LANG['js_languages']['separator_not_null'] = ' 分隔符號號不能為空。 ';
$_LANG['js_languages']['uploadfile_not_null'] = ' 請選擇要上傳的檔。 ';

$_LANG['use_help'] = ' 使用說明：' .
    '<ol>' .
    '<li> 上傳檔應為 CSV 檔 <br />'.
    'CSV 檔第一列為卡片序號；第二列為卡片密碼；第三列為使用截至日期。 <br />'.
    '(用 EXCEL 創建 csv 檔方法：在 EXCEL 中按卡號、卡片密碼、截至日期的順序填寫資料，完成後直接保存為 csv 檔即可)'.
    '<li> 密碼，和截至日期可以為空，截至日期格式為 2006-11-6 或 2006/11/6'.
...
$_LANG['user_guide'] = ' 使用說明：' .
    ...
    '<li> 加密串保存在檔 data/config.php 中，對應的常量是 AUTH_KEY</li>'.
    '<li> 如果要更改加密串在下面的文字方塊中輸入原加密串和新加密串，點 \' 確定 \' 按鈕後即可 </li>'.
    '</ol>';
