...
$_LANG['notice_gb_ship'] = '備註：團購活動未處裡為成功前，不能發貨';
...
$_LANG['phone'] = '電話';
$_LANG['group_buy'] = '（團購）';
$_LANG['error_get_goods_info'] = '獲取訂單商品資訊錯誤';
...
$_LANG['print_buy_name'] = '購貨人：';
$_LANG['label_consignee_address'] = '收貨地址：';
$_LANG['no_print_shipping'] = '很抱歉，現時您還沒有設定列印快遞單範本.不能進行列印';
...
$_LANG['label_inv_text_id'] = '納稅人識別號：';
...
$_LANG['order_removed'] = '訂單删除成功。';
$_LANG['return_list'] = '返回訂單清單';

/* 訂單處理提示 */
$_LANG ['surplus_not_enough'] = ' 該訂單使用 %s 餘額支付，現在使用者餘額不足';
$_LANG ['integral_not_enough'] = ' 該訂單使用 %s 積分支付，現在使用者積分不足';
...
$_LANG ['order_user_not_same'] = ' 要合併的兩個訂單不是同一個使用者下的';
...
$_LANG ['merge'] = ' 合併';
$_LANG ['notice_order_sn'] = ' 當兩個訂單不一致時，合併後的訂單資訊（如：支付方式、配送方式、包裝、賀卡、紅包等）以主訂單為准。 ';
...
/* 編輯訂單列印範本 */
$_LANG ['edit_order_templates'] = ' 編輯訂單列印範本';
$_LANG ['template_resetore'] = ' 還原範本';
$_LANG ['edit_template_success'] = ' 編輯訂單列印範本操作成功!';
...
$_LANG ['from_ad_js'] = ' 廣告：';
$_LANG ['from_goods_js'] = ' 商品站外 JS 投放';
...
$_LANG ['step']['consignee'] = ' 設置收貨人資訊';
$_LANG ['step']['shipping'] = ' 選擇配送方式';
$_LANG ['step']['payment'] = ' 選擇支付方式';
$_LANG ['step']['other'] = ' 設置其他資訊';
...
$_LANG ['admin'] = ' 管理員添加';
$_LANG ['search_goods'] = ' 按組件編號或商品名稱或商品貨號搜索';
$_LANG ['category'] = ' 分類';
$_LANG ['brand'] = ' 品牌';
$_LANG ['user_money_not_enough'] = ' 使用者餘額不足';
$_LANG ['pay_points_not_enough'] = ' 使用者積分不足';
...
$_LANG ['notice_user'] = '<strong> 注意： </strong> 搜尋結果只顯示前 20 條記錄，如果沒有找到相' .
...
$_LANG ['return_order_gift_integral_new'] = ' 由於取消、無效或退貨操作，退回支付訂單 %s 時使用的積分';
