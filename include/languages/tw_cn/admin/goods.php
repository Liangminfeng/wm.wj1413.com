...
$_LANG['sel_goods_suppliers'] = ' 請選擇供應商';
/*------------------------------------------------------ */
//-- 圖片處理相關提示資訊
/*------------------------------------------------------ */
$_LANG['no_gd'] = ' 您的伺服器不支援 GD 或者沒有安裝處理該圖片類型的擴展庫。 ';
$_LANG['img_not_exists'] = ' 沒有找到原始圖片，創建縮略圖失敗。 ';
$_LANG['img_invalid'] = ' 創建縮略圖失敗，因為您上傳了一個不正確圖片檔。 ';
$_LANG['create_dir_failed'] = 'images 資料夾不可寫，創建縮略圖失敗。 ';
...
$_LANG['shop_price_not_number'] = ' 價格不是數位';
...
$_LANG['lab_picture_url'] = ' 商品圖片外部 URL';
$_LANG['lab_thumb_url'] = ' 商品縮略圖外部 URL';
$_LANG['lab_train'] = ' 列車活動：';
...
$_LANG['notice_seller_note'] = ' 僅供商家自己看的資訊';
$_LANG['notice_storage'] = ' 庫存在商品為虛貨或商品存在貨品時為不可編輯狀態，庫存數值取決於其虛貨數量或貨品數量';
$_LANG['notice_keywords'] = ' 用空格分隔';
$_LANG['notice_user_price'] = ' 會員價格為 -1 時表示會員價格按會員等級折扣率計算。 你也可以為每個等級指定一個固定價格';
...
$_LANG['invalid_img_url'] = ' 商品相冊中第 %s 個圖片格式不正確!';

$_LANG['goods_img_too_big'] = ' 商品圖片檔太大了（最大值： %s ），無法上傳。 ';
$_LANG['goods_thumb_too_big'] = ' 商品縮略圖檔太大了（最大值： %s ），無法上傳。 ';
$_LANG['img_url_too_big'] = ' 商品相冊中第 %s 個圖片檔太大了（最大值： %s ），無法上傳。 ';
...
$_LANG['font_styles'] = array ('strong' => '加粗', ' em' => '斜體', 'u' => ' 底線 ' , 'strike' => ' 刪除線');
...
$_LANG['suppliers_no'] = ' 不指定供應商屬於本店商品';
$_LANG['suppliers_move_to'] = ' 轉移到供應商';
...
$_LANG['js_languages']['spec_price_not_number'] = ' 加價不是數位';
$_LANG['js_languages']['market_price_not_number'] = ' 市場價格不是數位';
...
$_LANG['js_languages']['volume_num_not_number'] = ' 優惠數量不是數位';
$_LANG['js_languages']['volume_price_not_null'] = ' 請輸入優惠價格';
$_LANG['js_languages']['volume_price_not_number'] = ' 優惠價格不是數位';
...
/*------------------------------------------------------ */
$_LANG['product'] = ' 貨品';
$_LANG['product_info'] = ' 貨品資訊';
$_LANG['specifications'] = ' 規格';
$_LANG['total'] = ' 合計：';
$_LANG['add_products'] = ' 添加貨品';
$_LANG['save_products'] = ' 保存貨品成功';
$_LANG['product_id_null'] = ' 貨品 id 為空';
$_LANG['cannot_found_products'] = ' 未找到指定貨品';
$_LANG['product_batch_del_success'] = ' 貨品大量刪除成功';
$_LANG['product_batch_del_failure'] = ' 貨品大量刪除失敗';
$_LANG['batch_product_add'] = ' 大量新增';
$_LANG['batch_product_edit'] = ' 大量編輯';
