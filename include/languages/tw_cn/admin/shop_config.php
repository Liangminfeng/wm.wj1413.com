...
$_LANG['cfg_name']['history_number'] = ' 流覽歷史數量';
...
$_LANG['cfg_name']['shop_url'] = 'PC 端網址';
...
$_LANG['cfg_name']['send_verify_email'] = ' 使用者註冊時自動發送驗證郵件';
$_LANG['cfg_name']['message_board'] = ' 是否啟用留言板功能';
$_LANG['cfg_name']['message_check'] = ' 使用者留言是否需要審核';
...
$_LANG['cfg_name']['sn_prefix'] = ' 商品貨號首碼';
$_LANG['cfg_name']['close_comment'] = ' 關閉網店的原因';
$_LANG['cfg_name']['watermark_Alpha'] = ' 浮水印透明度';
$_LANG['cfg_name']['icp_number'] = 'ICP 證書或 ICP 備案證書號';
...
$_LANG['cfg_name']['page_size'] = ' 商品分類頁清單的數量';
$_LANG['cfg_name']['article_page_size'] = ' 文章分類頁清單的數量';
...
$_LANG['cfg_name']['enable_gzip'] = ' 是否啟用 Gzip 模式';
$_LANG['cfg_name']['anonymous_buy'] = ' 是否允許未登錄使用者購物';
...
$_LANG['cfg_name']['test_mail_address'] = ' 郵寄地址';
...
$_LANG['cfg_name']['sms_ecmoban_user'] = ' 短信介面使用者名';
$_LANG['cfg_name']['sms_ecmoban_password'] = ' 短信介面密碼';
...
$_LANG['cfg_name']['sms_signin'] = ' 客戶註冊時是否傳送簡訊驗證碼';
...
$_LANG['cfg_name']['cron_method'] = ' 是否開啟命令列調用計畫任務';
...
$_LANG['cfg_name']['name_of_region_1'] = ' 一級配送區功能變數名稱稱';
$_LANG['cfg_name']['name_of_region_2'] = ' 二級配送區功能變數名稱稱';
$_LANG['cfg_name']['name_of_region_3'] = ' 三級配送區功能變數名稱稱';
$_LANG['cfg_name']['name_of_region_4'] = ' 四級配送區功能變數名稱稱';
$_LANG['cfg_name']['related_goods_number'] = ' 關聯商品顯示數量';
$_LANG['cfg_name']['visit_stats'] = ' 網站訪問統計';
$_LANG['cfg_name']['help_open'] = ' 使用者説明是否打開';

$_LANG['cfg_desc']['smtp'] = ' 設置郵件伺服器基本參數';
$_LANG['cfg_desc']['market_price_rate'] = ' 輸入商品售價時將自動根據該比例計算市場價格';
$_LANG['cfg_desc']['rewrite'] = 'URL 重寫是一種搜尋引擎優化技術，可以將動態的位址類比成靜態的 HTML 檔。 需要Apache的支援。 ';
$_LANG['cfg_desc']['integral_name'] = ' 您可以將消費積分重新命名。 例如：燒幣';
$_LANG['cfg_desc']['integral_scale'] = ' 每 100 積分可抵多少元現金';
$_LANG['cfg_desc']['integral_percent'] = ' 每 100 元商品最多可以使用多少元積分';
$_LANG['cfg_desc']['comments_number'] = ' 顯示在商品詳情頁的使用者評論數量。 ';
$_LANG['cfg_desc']['shop_title'] = ' 商店的標題將顯示在瀏覽器的標題列';
$_LANG['cfg_desc']['smtp_host'] = ' 郵件伺服器主機位址。 如果本機可以發送郵件則設置為localhost ';
$_LANG['cfg_desc']['smtp_user'] = ' 發送郵件所需的認證帳號，如果沒有就為空著';
$_LANG['cfg_desc']['bought_goods'] = ' 顯示多少個購買此商品的人還買過哪些商品';
$_LANG['cfg_desc']['currency_format'] = ' 顯示商品價格的格式， %s 將被替換為相應的價格數位。 ';
$_LANG['cfg_desc']['image_height'] = ' 如果您的伺服器支援 GD ，在您上傳商品圖片的時候將自動將圖片縮小到指定的尺寸。 ';
$_LANG['cfg_desc']['watermark'] = ' 浮水印檔須為 gif 格式才可支援透明度設置。 ';
$_LANG['cfg_desc']['watermark_Alpha'] = ' 浮水印的透明度，可選值為 0-100 。 當設置為100時則為不透明。 ';
$_LANG['cfg_desc']['invoice_content'] = ' 客戶要求開發票時可以選擇的內容。 例如：辦公用品。 每一行代表一個選項。 ';
$_LANG['cfg_desc']['stats_code'] = ' 您可以將其他訪問統計服務商提供的代碼添加到每一個頁面。 ';
$_LANG['cfg_desc']['cache_time'] = ' 前臺頁面緩存的存活時間，以秒為單位。 ';
$_LANG['cfg_desc']['qq'] = ' 如果您有多個客服的 QQ 號碼，請在每個號碼之間使用半形逗號（ , ）分隔。 ';
$_LANG['cfg_desc']['msn'] = ' 如果您有多個客服的 MSN 號碼，請在每個號碼之間使用半形逗號（ , ）分隔。 ';
$_LANG['cfg_desc']['ym'] = ' 如果您有多個客服的 Yahoo Messenger 號碼，請在每個號碼之間使用半形逗號（ , ）分隔。 ';
$_LANG['cfg_desc']['ww'] = ' 如果您有多個客服的淘寶旺旺號碼，請在每個號碼之間使用半形逗號（ , ）分隔。 ';
$_LANG['cfg_desc']['shop_logo'] = ' 請在上傳前將圖片的檔案名命名為 logo.gif';
$_LANG['cfg_desc']['enable_gzip'] = ' 啟用 Gzip 模式可壓縮發送頁面大小，加快網頁傳輸。 需要php支援Gzip。 如果已經用Apache等對頁面進行Gzip壓縮，請禁止該功能。 ';
$_LANG['cfg_desc']['skype'] = ' 如果您有多個客服的 Skype 號碼，請在每個號碼之間使用半形逗號（ , ）分隔。 提示：你需要在你的Skype隱私設置中啟用狀態顯示功能';
$_LANG['cfg_desc']['attr_related_number'] = ' 在商品詳情頁面顯示多少個屬性關聯的商品。 ';
$_LANG['cfg_desc']['user_notice'] = ' 該資訊將在使用者中心歡迎頁面顯示';
$_LANG['cfg_desc']['comment_factor'] = ' 選取較高的評論條件可以有效的減少垃圾評論的產生。 只有使用者訂單完成後才認為該使用者有購買行為';
...
$_LANG['cfg_desc']['bgcolor'] = ' 顏色請以 #FFFFFF 格式填寫';
$_LANG['cfg_desc']['cart_confirm'] = ' 允許您設置使用者點擊 「 加入購物車 」 後是否提示以及隨後的動作。 ';
$_LANG['cfg_desc']['use_how_oos'] = ' 使用缺貨處理時前臺訂單確認頁面允許使用者選擇缺貨時處理方法。 ';
$_LANG['cfg_desc']['send_service_email'] = ' 網店資訊中的客服郵寄地址不為空時，該選項有效。 ';
$_LANG['cfg_desc']['send_mail_on'] = ' 啟用該選項登錄後臺時，會自動發送郵件佇列中尚未發送的郵件';
$_LANG['cfg_desc']['sms_shop_mobile'] = ' 請先註冊手機短信服務再填寫手機號碼';
$_LANG['cfg_desc']['send_verify_email'] = '「 是否開啟會員郵件驗證 」 設為開啟時才可使用此功能';

$_LANG['cfg_range']['cart_confirm'][1] = ' 提示使用者，點擊 「 確定 」 進購物車';
$_LANG['cfg_range']['cart_confirm'][2] = ' 提示使用者，點擊 「 取消 」 進購物車';
...
$_LANG['cfg_range']['comment_factor']['0' ] = '所有使用者';
$_LANG['cfg_range']['comment_factor']['1' ] = '僅登錄使用者';
$_LANG['cfg_range']['comment_factor']['2' ] = '有過一次以上購買行為使用者';
$_LANG['cfg_range']['comment_factor']['3' ] = '僅購買過該商品使用者';
...
$_LANG['cfg_range']['sort_order_method']['0' ] = '降冪排列';
$_LANG['cfg_range']['sort_order_method']['1' ] = '昇冪排列';
$_LANG['cfg_range']['show_order_type'][0] = ' 清單顯示';
...
$_LANG['cfg_range']['goodsattr_style']['1' ] = '選項按鈕';
$_LANG['cfg_range']['goodsattr_style']['0' ] = '下拉清單';
...
$_LANG['cfg_range']['timezone']['1' ] = '(GMT +01:00) Amsterdam, Berlin, Brussels, Madrid, Paris, < b23>Rome';
...
$_LANG['cfg_range']['upload_size_limit']['-1' ] = '服務預設設置';
...
$_LANG['rewrite_confirm_apache'] = "URL Rewrite 功能要求您的 Web Server 必須是 Apache ， \\n 並且起用了 rewrite 模組。 \\n同時請您確認是否已經將htaccess.txt檔重命名為. htaccess。 \\n如果伺服器上還有其他的重寫規則請去掉注釋,請將RewriteBase 行的注釋去掉 , 並將路徑設置為伺服器請求的絕對路徑";
$_LANG['rewrite_confirm_iis'] = "URL Rewrite 功能要求您的 Web Server 必須安裝 IIS ， \\n 並且起用了 ISAPI Rewrite 模組。 \\n如果您使用的是ISAPI Rewrite商業版，請您確認是否已經將HTTPd.txt 檔重命名為HTTPd.ini。 如果您使用的是ISAPI Rewrite免費版，請您確認是否已經將HTTPd.txt檔內的內容複寫到 ISAPI Rewrite 安裝目錄中 HTTPd.ini 裡。 ";
$_LANG['gzip_confirm'] = "GZip 功能需要您的伺服器支援 zlib 擴展庫。 \\n如果您發現開啟Gzip後頁面出現亂碼，可能是您的伺服器已經開啟了 Gzip，您不需要在商城系統中再次開啟。 ";
...
$_LANG['msg_upload_failed'] = ' 上傳檔 %s 失敗，請檢查 %s 目錄是否可寫。 ';
$_LANG['smtp_ssl_confirm'] = ' 此功能要求您的 php 必須支援 OpenSSL 模組 , 如果您要使用此功能，請聯繫您的空間商確認支援此模組';
...
$_LANG['mail_settings_note'] = ' 如果您的伺服器支援 Mail 函數（具體資訊請諮詢您的空間供應商）。 我們建議您使用系統的 Mail 函數。 <br />當您的伺服器不支援 Mail 函數的時候您也可以選用 SMTP 作為郵件伺服器。 ';
...
$_LANG['js_languages']['smtp_host_empty'] = ' 您沒有填寫郵件伺服器位址!';
$_LANG['js_languages']['smtp_port_empty'] = ' 您沒有填寫伺服器埠!';
$_LANG['js_languages']['reply_email_empty'] = ' 您沒有填寫郵件回復位址!';
$_LANG['js_languages']['test_email_empty'] = ' 您沒有填寫發送測試郵件的位址!';
$_LANG['js_languages']['email_address_same'] = ' 郵件回復位址與發送測試郵件的位址不能相同!';
...
$_LANG['cfg_name']['wap_logo'] = ' 微商城 LOGO 上傳';
$_LANG['cfg_desc']['wap_logo'] = ' 為了更好地相容各種手機類型， LOGO 最好為 png 圖片';
...
$_LANG['cfg_name']['present_integral']= ' 贈送積分';
$_LANG['cfg_range']['present_integral'][0]= ' 局部';
$_LANG['cfg_range']['present_integral'][1]= ' 全域';
$_LANG['cfg_desc']['present_integral'] = ' 局部：按設置商品贈送積分，全域：統一比例贈送積分';

$_LANG['cfg_name']['proportion_integral']= ' 贈送積分比例';
