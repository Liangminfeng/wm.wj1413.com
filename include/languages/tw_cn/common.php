...
$_LANG['tag_exists'] = '您已經為該商品添加過壹個標記，請不要重復提交.';
$_LANG['tag_cloud'] = '標簽雲';
$_LANG['tag_anonymous'] = '對不起，只有註冊會員並且正常登錄以後才能提交標記。';
$_LANG['tag_cloud_desc'] = '標簽雲（Tag cloud）是用以表示壹個網站中的內容標簽。 標簽（tag、關鍵詞）是壹種更為靈活、有趣的商品分類方式，您可以為每個商品添加壹個或多個標簽，那麽可以通過點擊這個標簽查看商品其他會員提交的與您的標簽壹樣的商品,能夠讓您使用最快的方式查找某壹個標簽的所有網店商品。比方說點擊“紅色”這個標簽，就可以打開這樣的壹個頁面，顯示所有的以“紅色” 為標簽的網店商品';
...
$_LANG['snatch_victory_desc'] = '當本期活動截止時，系統將從所有競價獎品的用戶中，選出在所有競價中出價最低、且沒有其他出價與該價格重復的用戶（即最低且唯壹競價），成為該款獎品的獲勝者.';
...
$_LANG['use_surplus'] = '使用余額';
$_LANG['your_surplus'] = '您當前的可用余額為';
$_LANG['pay_fee'] = '支付手續費';
...
$_LANG['self_site'] = '本站';
$_LANG['order_gift_integral'] = '訂單 %s 贈送的KD豆';
...
$_LANG['gbs_pre_start'] = '該團購活動尚未開始，請繼續關註。';
