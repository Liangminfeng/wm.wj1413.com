...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        /* 生成支付按钮 */
        $button = '<script type="text/javascript" src="'.__PUBLIC__.'/js/ap.js"></script><div class="paypal"><input type="button" onclick="javascript:_AP.pay(\'' . $gateway . $param . '&sign=' . md5($sign) . '\')" value="支付宝付款" class="c-btn3" /></div>';
        return $button;
    }
