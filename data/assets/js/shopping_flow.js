...
function changeIntegralResponse(obj)
{
  ...
  else
  {
    ...
    document.getElementById('integral_money').innerHTML = "-"+"¥"+obj.content.integral_money;
    document.getElementById("integral_total").style.display="block";
   //
   var acc = accAdd(obj.content.goods_price,obj.content.shipping_fee);
   var Sub = accSub(acc,obj.content.integral_money);

    document.getElementById('order_money').innerHTML ="¥"+Sub ;
   // document.getElementById('integral_submit').value = obj.content.integral;

    document.getElementById('integral_money_submit').value = obj.content.integral_money;
    document.getElementById('order_money_submit').value = obj.content.goods_price+obj.content.shipping_fee-obj.content.integral_money;
    // document.getElementById('order_money').innerHTML = obj.content.integral_money;
    //orderSelectedResponse(obj.content);
  }
}
/**
...
function checkOrderForm(frm)
{
  ...
  if($("#changeprovince option:selected").val()=="请选择"){
      alert("请输入省份")
      return false
  }
