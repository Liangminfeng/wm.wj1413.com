<div class="search-div ts-3">
	<section class="search">
		...
		<div class="text-all dis-box j-text-all">
			<a class="a-icon-back j-close-search" href="javascript:history.go(-1);location.reload()"><i class="iconfont icon-jiantou is-left-font"></i></a>
			...
			<button type="submit" class="btn-submitPro"><?php echo $this->_var['lang']['search']; ?></button>
		</div>
		</form>
	</section>
...
?>
		...
		<p class="hos-search">
			<label class="fl"><?php echo $this->_var['lang']['latest_search']; ?></label>
