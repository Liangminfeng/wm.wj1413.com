...
<table width="100%" >
  ...
  <tr>
    ...
    <td><?php echo $this->_var['user']['balance']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>&account_type=1">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> </td>
  </tr>
  <tr>
    <td class="label"><?php echo $this->_var['lang']['frozen_money']; ?>:</td>
    <td><?php echo $this->_var['user']['frozen_money']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>&account_type=9">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> </td>
  </tr>
  <tr>
    ...
    <td><?php echo $this->_var['user']['rank_points']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>&account_type=5">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="noticeRankPoints"><?php echo $this->_var['lang']['notice_rank_points']; ?></span></td>
  </tr>
  <tr>
    ...
    <td><?php echo $this->_var['user']['pay_points']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>&account_type=6">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> <br />
  ...
  <tr>
    ...
    <td><input type="text" name="email" maxlength="60" size="40" value="<?php echo $this->_var['user']['email']; ?>" /></td>
  </tr>
  ...
  <tr>
    ...
    <td><input name="mobile_phone" type="text" id="mobile_phone" value="<?php echo $this->_var['user']['mobile_phone']; ?>" size="10" /></td>
  </tr>
...
?>
  ...
  <tr>
    <td class="label">IDCARD:</td>
  
    <td><input name="ID_card" type="text" readonly="readonly"  value="<?php echo $this->_var['user']['ID_card']; ?>" size="30" /></td>
  </tr>
...
<!--   <tr>
    <td class="label"><?php echo $this->_var['lang']['parent_user']; ?>:</td>
      <input name="oldparent_username" type="hidden" id="parent_user" value="<?php echo $this->_var['user']['parent_username']; ?>"/>
    <td><input name="parent_username" type="text" id="parent_user" value="<?php echo $this->_var['user']['parent_username']; ?>" size="10" /></td>
  </tr> -->
  <tr>
    <td class="label">成长值:</td>

    <td><input name="level_xp" type="text" id="level_xp" value="<?php echo $this->_var['user']['level_xp']; ?>" size="10" /></td>
  </tr>
  <tr>
    <td class="label">身份:</td>
    <td><select name="user_vip">
  
      <?php echo $this->html_options(array('options'=>$this->_var['get_user_vip_list'],'selected'=>$this->_var['user']['user_vip'])); ?>
    </select></td>
  </tr>
   <tr>
    ...
    <td><select name="status">
      ...
      <?php echo $this->html_options(array('options'=>$this->_var['get_status_list'],'selected'=>$this->_var['user']['status'])); ?>
    </select></td>
  </tr>
<!--    <tr>
    <td class="label">安置人:</td>
    <input name="oldesettlement" type="hidden" id="parent_user" value="<?php echo $this->_var['esettlement']; ?>"/>
    <td><input name="esettlement" type="text" id="parent_user" value="<?php echo $this->_var['esettlement']; ?>" size="10" /></td>
  </tr>
   <tr>
    <td class="label">安置人点位:</td>
    <input name="oldesettlementArea" type="hidden" id="parent_user" value="<?php echo $this->_var['esettlementArea']; ?>" size="10" />
    <td><input name="esettlementArea" type="text" id="parent_user" value="<?php echo $this->_var['esettlementArea']; ?>" size="10" /></td>
  </tr> -->
