...
if ($_REQUEST['act'] =='update')
{
    ...
    if (empty($_FILES['file']['error']) || (!isset($_FILES['file']['error']) && isset($_FILES['file']['tmp_name']) && $_FILES['file']['tmp_name'] != 'none'))
    {
        ...
        // 复制文件
        $file_url = $image->upload_image($_FILES['file'], 'aritilce');
    }
    ...
    if ($exc->edit("title='$_POST[title]', cat_id='$_POST[article_cat]',click_count='$_POST[click_count]', article_type='$_POST[article_type]', is_open='$_POST[is_open]', author='$_POST[author]', author_email='$_POST[author_email]', keywords ='$_POST[keywords]', file_url ='$file_url', open_type='$open_type', content='$_POST[FCKeditor1]', link='$_POST[link_url]', description = '$_POST[description]'", $_POST['id']))
    {
