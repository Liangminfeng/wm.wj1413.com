...
//商品管理权限
    ...
    $purview['postercat_list']           = 'postercat_list';
    $purview['poster_list']           = 'poster_list';
    $purview['goods_kd_cash_scale']           = 'goods_kd_cash_scale';
//促销管理权限
...
//  $purview['02_snatch_list']       = 'gift_manage';  //赠品管理
    ...
    $purview['09_talk_manage']             = 'talk_manage';
    $purview['10_talk_manage']             = 'talk_sucai_list';
//文章管理权限
...
//会员管理权限
    ...
    $purview['03_accountlog_list']   = 'accountloglist';
...
//订单管理权限
    ...
    $purview['aftermarket_rf_edit']        = 'aftermarket_rf_edit';
    $purview['aftermarket_rc_edit']        = 'aftermarket_rc_edit';
    $purview['aftermarket_ff_edit']        = 'aftermarket_ff_edit';
    $purview['aftermarket_edit']        = 'aftermarket_edit';
