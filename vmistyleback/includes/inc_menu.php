...
$modules['02_menu_goods']['06_goods_kd_cash_scale'] = 'user_vip_rank.php?act=list';
$modules['02_menu_goods']['66_partner_manage'] = 'partner_manage.php?act=list';
...
$modules['04_menu_members']['04_accountlog_list']       = 'accountlog.php?act=accountloglist';

$modules['04_menu_members']['04_users_add']              = 'users.php?act=add';
$modules['04_menu_members']['05_user_rank_list']         = 'user_rank.php?act=list';
$modules['04_menu_members']['13_users_add']              = 'users.php?act=manualadd';
...
$modules['04_menu_members']['12_user_autonym']           = 'user_autonym.php?act=list';
...
$modules['05_menu_content']['33_poster_list']           = 'poster.php?act=list';
$modules['05_menu_content']['32_postercat_list']           = 'postercat.php?act=list';
...
$modules['06_menu_promotion']['16_train']        = 'train.php?act=list';
$modules['06_menu_promotion']['17_lottery']        = 'lottery.php?act=index';
$modules['06_menu_promotion']['18_talk']        = 'talk.php?act=list';
$modules['06_menu_promotion']['19_sucai']        = 'sucai.php?act=list';
