...
listTable.edit = function(obj, act, id)
{
  ...
  txt.onblur = function(e)
  {
    if (Utils.trim(txt.value).length > 0)
    {
      ...
      alert(33);
      if(res.id && (res.act == 'delete'))
      {
          document.getElementById('del'+res.id).innerHTML = "<a href=\""+ thisfile +"?sucai_id="+ res.id +"&act=del\" onclick=\"return confirm('"+deleteck+"');\">"+deleteid+"</a>";
      }
