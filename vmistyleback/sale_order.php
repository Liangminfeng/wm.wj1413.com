...
if (isset($_REQUEST['act']) && ($_REQUEST['act'] == 'query' ||  $_REQUEST['act'] == 'download'))
{
    ...
    {
        $_REQUEST['start_date'] = date('Y-m-d', $_REQUEST['start_date']);
        $_REQUEST['end_date'] = date('Y-m-d', $_REQUEST['end_date']);
    }
...
else
{
    ...
    $smarty->assign('start_date',       date('Y-m-d', $_REQUEST['start_date']));
    $smarty->assign('end_date',         date('Y-m-d', $_REQUEST['end_date']));
