...
elseif ($_REQUEST['act'] == 'addtolist')
{
    ...
    if ($count > $start)
    {
        ...
        while ($rt = $db->fetch_array($query))
        {
            ...
            $smarty->assign(array('user_name'=>$rt['user_name'],'goods_name'=>$rt['goods_name'],'goods_url'=>$goods_url,'shop_name'=>$_CFG['shop_title'], 'send_date'=>date($_CFG['date_format'])));
...
function get_attention()
{
    ...
    {
        $goodsdb[$k]['last_update'] = date('Y-m-d', $v['last_update']);
    }
