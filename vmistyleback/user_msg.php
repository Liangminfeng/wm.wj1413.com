...
elseif ($_REQUEST['act']=='action')
{
    ...
    {
        $sql = "UPDATE ".$ecs->table('feedback')." SET user_name = '".$_SESSION['admin_name']."', user_email = '".$_POST['user_email']."', msg_content='".$_POST['msg_content']."', msg_time = '".time()."' WHERE msg_id = '".$_REQUEST['parent_id']."'";
        $db->query($sql);
    }
